...
if (isset($_POST['update_product'])) {
 ...
 $query = "UPDATE producttable SET product_name='$productName',category='$category',region='$region', season='$season',	quantity='$quantity',production_cost='$productionCost',	production_date='$productionDate',expire_date='$expirationDate' WHERE id='$product_id'";
...
if (isset($_POST["add_product"])) {
 ...
 $query = "INSERT INTO producttable (product_name,category,region,season,quantity,production_cost,	production_date,expire_date) VALUES ('$productName','$category','$region','$season','$quantity','$productionCost','$productionDate','$expirationDate')";
}
