...
if (isset($_POST['add_to_cart'])) {
 ...
 // Add purchase data to demandcart
 $purchase_date = date('Y-m-d'); // Current date
 $conn->query("INSERT INTO demandcart (product_id, customer_id, purchase_quantity, purchase_price, purchase_date) 
                  VALUES ($product_id, $customer_id, $purchase_quantity, $purchase_price, '$purchase_date')");
