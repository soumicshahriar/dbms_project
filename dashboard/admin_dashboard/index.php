 ...
 <div class="dashboard">
  ...
  <main>
   <section id="content">
    ...
    <p>Select a topic from the sidebar to load information.</p>

    <!-- Button to open insert form -->
    <button onclick="openInsertForm()">Add New Record</button>
     ...
     if ($result->num_rows > 0) {
      ...
      while ($row = $result->fetch_assoc()) {
       echo "<tr>
                                ...
                                <td>" . $row['cost'] . "</td>
                                <td>
                                    <button onclick='openUpdateForm(" . $row['id'] . ", \"" . $row['year'] . "\", \"" . $row['yield'] . "\", \"" . $row['acreage'] . "\", \"" . $row['cost'] . "\")'>Update</button>
